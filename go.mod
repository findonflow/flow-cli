...
require (
	...
	github.com/onflow/flow-nft/lib/go/contracts v0.0.0-20220606143647-47126d1009e2 // indirect
...
replace github.com/onflow/flow-emulator => github.com/onflow/flow-emulator v0.33.4-0.20220708220218-089593355358
